#!/usr/bin/env python3
"""Cluster all app snapshots using existing embeddings in Neon."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Cluster all embeddings in Neon")
    ...
    parser.add_argument("--scope-label", default="all", help="Value for the app_snapshot_clusters.scope column")
